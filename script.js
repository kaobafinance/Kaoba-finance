...
const salario2Div=document.getElementById("titular2Div");
...
// mostrar titular 2 solo si se selecciona 2
...
function calcularPerfil(){
  ...
  let tipoRef=(parseFloat(document.getElementById("euriborValor").innerText.replace(',','.'))+2)/100/12 || 0.028/12;
  let n=plazoMax*12;
  ...
  if(yaTieneVivienda.checked){
    ...
    let impuestos=perfilTipoVivienda.value==="primera"?0.10*precio:
